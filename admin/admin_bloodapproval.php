               ...
               <div class="col-md-12">
                  <div class="card">
                     <div class="card-header">
                        <h4>Lists of Blood Requests Granted</h4>
                     </div>
                     <table class="table table-striped">
                        ...
                        <tbody>
                           <?php
                              $resTable = mysqli_query($conn,"SELECT * FROM tb_bloodapproval");
                              while($rowTbl = mysqli_fetch_array($resTable)){
                                  echo "<tr>";
                                  echo "<tr>";
                                  echo "<td>" . $rowTbl['controlno'] . "</td>";
                                  echo "<td>" . $rowTbl['request_controlno'] . "</td>";
                                  echo "<td>" . $rowTbl['approval_date'] . "</td>";
                                  echo "</tr>";
                                  }
                              ?>
                        </tbody>
