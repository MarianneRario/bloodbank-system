...
$tb_bloodrequest = mysqli_query($con, "SELECT * FROM tb_bloodrequest WHERE msg='PENDING'");
...
$pdf->cell(100,10,'Total Number of Blood Request',0,1);
...
$pdf->Output('D','Total Number of Blood Request.pdf');;