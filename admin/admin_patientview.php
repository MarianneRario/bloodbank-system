...
<html lang="en">
   ...
   <body>
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item px-2">
                     <a href="#" class="nav-link active">Patient</a>
                  </li>
                  <li class="nav-item px-2">
            ...
            <div class="col-md-6 ml-auto mb-4">
               ...
               <form class="form-inline" method="post">
                  ...
                  <div class="input-group-append">
                     <button name="searchPatient" class="btn btn-primary">Search</button>
                  </div>
               </div>
            </div>
         </div>
      ...
      <!-- TABLE -->
      <section id="patient_table">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="card">
                     <div class="card-header">
                        <h4>Lists of Patients</h4>
                     </div>
                     <table class="table table-striped">
                        ...
                        <tbody>
                           <?php
                              $resTable = mysqli_query($conn,"SELECT * FROM tb_patient");
                              while($rowTbl = mysqli_fetch_array($resTable)){
                                  echo "<tr>";
                                  echo "<tr>";
                                  echo "<td>" . $rowTbl['patient_id'] . "</td>";
