                     ...
                     <table class="table table-striped">
                        <thead class="thead-dark">
                           <tr>
                              <th>Blood Id</th>
                              <th>Blood Type</th>
                              <th>Blood Pint Stored</th>
                           </tr>
                        </thead>
                        <tbody>
                           <?php
                              $resTable = mysqli_query($conn,"SELECT * FROM tb_bloodavailability");
                              while($rowTbl = mysqli_fetch_array($resTable)){
                                  echo "<tr>";
                                  echo "<tr>";
                                  echo "<td>" . $rowTbl['blood_id'] . "</td>";
                                  echo "<td>" . $rowTbl['blood'] . "</td>";
                                  echo "<td>" . $rowTbl['quantity'] . "</td>";
                                  echo "</tr>";
                                  }
                              ?>
                        </tbody>
