...
$tb_bloodrequest = mysqli_query($con, "SELECT * FROM tb_bloodrequest WHERE msg='APPROVED'");
...
$pdf->cell(100,10,'Total Number of Approved Request',0,1);
...
$pdf->Output('D','Total Number of Approved Request.pdf');;