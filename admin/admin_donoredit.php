...
<html lang="en">
   ...
   <body>
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item px-2">
                     <a href="admin_donorview.php" class="nav-link active">Donor</a>
                  </li>
                  <li class="nav-item px-2">
      ...
      <?php 
         $id = $_SESSION["id"];
         $sql1 = "SELECT * FROM tb_donor WHERE donor_id = '$id'";
                        ...
                        <form method = "post">
                           ...
                           <div class="form-row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text"name="id" class="form-control" value="<?php echo $row1['donor_id'] ?>" readonly>
                              </div>
                              <div class="form-group col-md-6">
                           ...
                           <button type="submit" name="savedonordata" class="btn btn-success btn-block">
                           <i class="fas fa-check"></i>
                           SAVE DATA
                           </button>
                           <button type="submit" name="deletedonordata" class="btn btn-danger btn-block">
