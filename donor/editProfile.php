                     ...
                     <form method = "post">
                           ...
                           <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" name="contactno" class="form-control" value="<?php echo $row['contactnum'] ?>">
                              </div>
                           </div>
                           <div class="form-row">
                              <div class="form-group col-md-6">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" value="<?php echo $row['registration_date'] ?>" readonly>
                              </div>
                           </div>
                           <br>
                           ...
                           <div class="form-row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text"name="id" class="form-control" value="<?php echo $row['donor_id'] ?>" readonly>
                              </div>
                              <div class="form-group col-md-6">
                                 <label for="inputPassword4">Blood Type</label>
                                 <input type="text" class="form-control" value="<?php echo $row['bloodtype'] ?>" readonly>
                              </div>
                           </div>
                           <div class="form-row">
                              <div class="form-group col-md-6">
                                 <label for="inputEmail4">Total Blood Donation</label>
                                 <input type="email" class="form-control" value = "<?php echo $resCount['count(donor_id)'] ?>" readonly>
                              </div>
                              <div class="form-group col-md-6">
                           ...
                           <button type="submit" name="saveuserdonor" class="btn btn-primary btn-block">
