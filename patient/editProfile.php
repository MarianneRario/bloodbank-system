   ...
   <body>
      ...
      <section id="actions" class="py-4 mb-4 bg-light">
         <div class="container">
            <div class="row">
               <div class="col-md-3">
                  <a href="patient.php" class="btn btn-light btn-block">
                        ...
                        <form method="POST">
                           ...
                           <div class="form-row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="email" class="form-control" id="inputEmail4" value = "<?php echo $resCount['count(patient_id)'] ?>" readonly>
                              </div>
                              <div class="form-group col-md-6">
                           ...
                           <button type="submit" name="saveuserpatient" class="btn btn-success btn-block">
